# 2040_Telegram_Splitout_Automation_Webhook Rehber

Bu rehber `2040_Telegram_Splitout_Automation_Webhook.json` dosyasındaki iş akışının ayrıntılı kurulumu ve kullanımı için hazırlanmıştır.
...
## Kurulum Adımları
1. n8n arayüzünde **"Workflow" → "Import from file"** seçeneği ile `2040_Telegram_Splitout_Automation_Webhook.json` dosyasını içe aktarın.

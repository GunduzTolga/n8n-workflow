# 2007_Webhook_Graphql_Automate_Webhook Rehber

Bu rehber `2007_Webhook_Graphql_Automate_Webhook.json` dosyasındaki iş akışının ayrıntılı kurulumu ve kullanımı için hazırlanmıştır.
...
## Kurulum Adımları
1. n8n arayüzünde **"Workflow" → "Import from file"** seçeneği ile `2007_Webhook_Graphql_Automate_Webhook.json` dosyasını içe aktarın.

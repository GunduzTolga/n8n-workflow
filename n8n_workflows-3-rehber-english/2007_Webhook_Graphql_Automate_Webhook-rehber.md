...
[Shopify graphql API Docs] (https://shopify.dev/docs/api/admin-grraphql)

To make it easy to Build Queries for the Graphql API Easy Please Check Out the [Graphiql App for the Admin API]
